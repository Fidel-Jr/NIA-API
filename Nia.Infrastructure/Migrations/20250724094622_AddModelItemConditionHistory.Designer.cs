...
namespace Nia.Infrastructure.Migrations
{
    ...
    [Migration("20250724094622_AddModelItemConditionHistory")]
    partial class AddModelItemConditionHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nia.Domain.Entities.BorrowTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ItemId")
                        .HasDatabaseName("ix_borrow_transactions_item_id");
            ...
            modelBuilder.Entity("Nia.Domain.Entities.ItemConditionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_item_condition_histories");

                    b.HasIndex("ConditionId")
                        .HasDatabaseName("ix_item_condition_histories_condition_id");

                    b.HasIndex("ConditionNumberId")
                        .HasDatabaseName("ix_item_condition_histories_condition_number_id");

                    b.HasIndex("ItemId")
                        .HasDatabaseName("ix_item_condition_histories_item_id");

                    b.HasIndex("QrCodeId")
                        .HasDatabaseName("ix_item_condition_histories_qr_code_id");

                    b.ToTable("item_condition_histories", (string)null);
                });
            ...
            modelBuilder.Entity("Nia.Domain.Entities.BorrowTransaction", b =>
                {
                    b.HasOne("Nia.Domain.Entities.User", "Borrower")
                        .WithMany()
                    ...
                    b.HasOne("Nia.Domain.Entities.Item", "Item")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_borrow_transactions_items_item_id");
            ...
            modelBuilder.Entity("Nia.Domain.Entities.ItemConditionHistory", b =>
                {
                    b.HasOne("Nia.Domain.Entities.Condition", "Condition")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_condition_histories_conditions_condition_id");
                    ...
                    b.HasOne("Nia.Domain.Entities.ConditionNumber", "ConditionNumber")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_condition_histories_condition_numbers_condition_number");
                    ...
                    b.HasOne("Nia.Domain.Entities.Item", "Item")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_condition_histories_items_item_id");

                    b.HasOne("Nia.Domain.Entities.QRCode", "QrCode")
                        .WithMany()
                        .HasForeignKey("QrCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_condition_histories_qr_codes_qr_code_id");
